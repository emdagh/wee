...
int main(int, char**) {
    ...
    auto t1 = make_time_point(1899,12,28,18,0,0);
    auto t2 = make_time_point(1970, 1, 1);

    std::cout << std::setprecision(16);
    std::cout << to_time_point(offset) << std::endl;
    std::cout << to_time_point(-2.5) << std::endl;
    std::cout << to_time_point(-1.25) << std::endl;
    std::cout << wee::to_oadate(to_time_point(-10.25)) << std::endl;
    std::cout << wee::to_oadate(t2) << std::endl;
